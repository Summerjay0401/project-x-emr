  ...
  return (
    <List sx={{ width: '100%', maxWidth: 360, bgcolor: 'background.paper' }}>
      ...
      <ListItem>
        ...
        <ListItemText primary="Dermatologist"/>
      </ListItem>
    </List>
  );
}
  ...
  return (
    <List sx={{ width: '100%', maxWidth: 360, bgcolor: 'background.paper' }}>
      <ListItem>
        ...
        <ListItemText primary="Cardiologist" />
      </ListItem>
      <ListItem>
        <ListItemAvatar>
          <Avatar>
  ...
  return (
    <List sx={{ width: '100%', maxWidth: 360, bgcolor: 'background.paper' }}>
      <ListItem>
        ...
        <ListItemText primary="Allergist" />
      </ListItem>
      <ListItem>
        <ListItemAvatar>
          <Avatar>
        ...
        <ListItemText primary="Endocrinologist" />
      </ListItem>
      <ListItem>
        <ListItemAvatar>
          <Avatar>
        ...
        <ListItemText primary="Opthalmologist"/>
      </ListItem>
    </List>
  );
}